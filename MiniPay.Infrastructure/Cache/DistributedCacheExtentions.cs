...
namespace MiniPay.Infrastructure.Cache
{
    public static class DistributedCacheExtentions
    {
        ...
        public static async Task<T?> GetOrSetAsync<T>(this IDistributedCache cache, string key, Func<Task<T>> factory, DistributedCacheEntryOptions? options = null, CancellationToken cancellationToken = default)
        {
